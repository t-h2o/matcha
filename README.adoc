...
Copy from the container the flask_socketio package into my current folder to explore it

----
docker exec flask-dev cp -R /usr/local/lib/python3.9/site-packages/flask_socketio /app
----
