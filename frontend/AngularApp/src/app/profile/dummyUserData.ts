export let dummyUserData = {
    ...
    interests: ['hiking', 'biking', 'swimming', 'reading', 'cooking', 'traveling'],
    pictures: [ "johnnyAppleseed1", "johnnyAppleseed2", "johnnyAppleseed3", "johnnyAppleseed4", "johnnyAppleseed5" ],
